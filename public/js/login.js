...
$.get("/api/users", function(req) {
  ...
  if ( req.length == 0) {
    $("#signInDisplay").html( "<h3 class= 'hiddenContainer'>Welcome to Brew One!  Plese create your admin account below:</h3>" +
                              "<form class='signup hiddenContainer' id='adminSignUp' name='userSignUp' method='post' action='/memberauth'>" +
